...
from .. import sn74hc595_ns, SN74HC595Component, CONF_SN74HC595_ID
...
CONFIG_SCHEMA = display.BASIC_DISPLAY_SCHEMA.extend({
    ...
    cv.GenerateID(CONF_SN74HC595_ID): cv.use_id(SN74HC595Component)
...
async def to_code(config):
    ...
    parent = await cg.get_variable(config[CONF_SN74HC595_ID])
